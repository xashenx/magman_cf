...
<div id="wrapper">
    <nav class="navbar navbar-default navbar-cls-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html"><img src="{{ URL::asset('assets/img/logo.png') }}"
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                @if(Auth::user()->level_id == 1)
                    <li>
                        <a href="{{ URL::asset('newShipment') }}"><i class="fa fa-plus-square fa-3x sidebar-icon"></i>
                            Nuovi Arrivi</a>
                    </li>
                    <li>
                ...
                @if(Auth::user()->level_id == 2)
                    ...
                    <li>
                        <a href="{{ URL::asset('mail') }}"><i class="fa fa-user fa-3x sidebar-icon"></i> Contatti</a>
                    </li>
                @endif
                @if(Auth::user()->level_id == 1)
                    <li>
                ...
                @if(Auth::user()->level_id == 100)
                    <li>
                        <a href="#"><i class="fa fa-gear fa-3x sidebar-icon"></i> Gestione parametri fissi<span
